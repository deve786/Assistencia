...
if(isset($_POST['login']))
{
	...
	try{
		...
		$row=0;
		$result=mysqli_query($conn,"select * from teachers where teacher_username='$_POST[username]' and teacher_password='$_POST[password]'");
...
<head>
    ...
    <title>Asistencia - Teacher Login</title>
    <!-- google-fonts -->
